namespace Sitecore.Commerce.Sample.Console
{
    ...
    public static class Pricing
    {
        ...
        private static readonly Sitecore.Commerce.Engine.Container Container = new CsrSheila().Context.ShopsContainer();
        ...
        private static void AddPriceBook()
        {
            ...
            var result = Proxy.DoCommand(Container.AddPriceBook("ConsolePriceBook", "displayname", "description", "{0F65742E-317F-44B0-A4DE-EBF06209E8EE}"));
            ...
            result = Proxy.DoCommand(Container.AddPriceBook("ConsolePriceBook", "displayname", "description", "{0F65742E-317F-44B0-A4DE-EBF06209E8EE}"));
            ...
            result = Proxy.DoCommand(Container.AddPriceBook("ConsolePriceBook1", string.Empty, string.Empty, string.Empty));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
            
            result = Proxy.DoCommand(Container.AddPriceBook("ConsolePriceBook2", "displayname", "description", "{0F65742E-317F-44B0-A4DE-EBF06209E8EE}"));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();

            result = Proxy.DoCommand(Container.AddPriceBook("ConsolePriceBook3", string.Empty, "description", "{0F65742E-317F-44B0-A4DE-EBF06209E8EE}"));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();

            result = Proxy.DoCommand(Container.AddPriceBook("ConsolePriceBook4", "displayname", string.Empty, "{0F65742E-317F-44B0-A4DE-EBF06209E8EE}"));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();

            result = Proxy.DoCommand(Container.AddPriceBook("ConsolePriceBook5", "displayname", "description", string.Empty));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
        }
        ...
        private static void GetPriceBook()
        {
            ...
            var result = Proxy.GetValue(Container.PriceBooks.ByKey(_priceBookFriendlyId).Expand("Components"));
            result.Should().NotBeNull();
        }
        ...
        private static void EditPriceBook()
        {
            ...
            var result = Proxy.DoCommand(Container.EditPriceBook(_priceBookFriendlyId, "edited description", "edited diplay name", "{0F65742E-317F-44B0-A4DE-EBF06209E8EE}"));
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
        }
        ...
        private static void GetBookAssociatedCatalogs()
        {
            ...
            var result = Proxy.Execute(Container.GetPriceBookAssociatedCatalogs("AdventureWorksPriceBook")).ToList();
            result.Should().NotBeNull();
        ...
        private static void AssociatedCatalogToBook()
        {
            ...
            var result = Proxy.DoCommand(Container.AssociateCatalogToPriceBook("AdventureWorksPriceBook", "Adventure Works Catalog"));
            result.Should().NotBeNull();
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
        ...
        private static void DisassociatedCatalogFromBook()
        {
            ...
            var result = Proxy.DoCommand(Container.DisassociateCatalogFromPriceBook("AdventureWorksPriceBook", "Adventure Works Catalog"));
            result.Should().NotBeNull();
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
            result.Messages.Any(m => m.Code.Equals("information", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
        }
        ...
        private static void AddPriceCard()
        {
            ...
            var result = Proxy.DoCommand(Container.AddPriceCard(_priceBookFriendlyId, "ConsolePriceCard", "displayname", "description"));
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
            ...
            result = Proxy.DoCommand(Container.AddPriceCard(_priceBookFriendlyId, "ConsolePriceCard", "displayname", "description"));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");

            result = Proxy.DoCommand(Container.AddPriceCard(_priceBookFriendlyId, "ConsolePriceCard1", string.Empty, "description"));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();

            result = Proxy.DoCommand(Container.AddPriceCard(_priceBookFriendlyId, "ConsolePriceCard2", "displayname", string.Empty));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
        }
        ...
        private static void EditPriceCard()
        {
            ...
            var result = Proxy.DoCommand(Container.EditPriceCard(_priceCardFriendlyId, "edited display name", "edited description"));
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
        }
        ...
        private static void DeletePriceCard()
        {
            ...
            result = Proxy.DoCommand(Container.DeletePriceCard(_priceCardFriendlyId));
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();

            result = Proxy.DoCommand(Container.DeletePriceCard(_duplicatedPriceCardFriendlyId)); // DELETING CLONED CARD 
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
        }
        ...
        private static void DuplicatePriceCard()
        {
            ...
            result = Proxy.DoCommand(Container.DuplicatePriceCard(_priceCardFriendlyId, "ConsolePriceCardDuplicate"));
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
        ...
        private static void AddPriceSnapshot()
        {
            ...
            result = Proxy.DoCommand(Container.AddPriceSnapshot(_priceCardFriendlyId, snapshotDate));
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
        ...
        private static void EditPriceSnapshot()
        {
            ...
            result = Proxy.DoCommand(Container.EditPriceSnapshot(_priceCardFriendlyId, "InvalidSnapshot", beginDate));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");

            result = Proxy.DoCommand(Container.EditPriceSnapshot(_priceCardFriendlyId, _priceSnapshotId, beginDate));
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
            var card = GetPriceCard();
            var snapshot = card?.Snapshots.FirstOrDefault(s => s.Id.EndsWith(_priceSnapshotId));
        ...
        private static void RemovePriceSnapshot()
        {
            ...
            result = Proxy.DoCommand(Container.RemovePriceSnapshot(_priceCardFriendlyId, "InvalidSnapshot"));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");

            result = Proxy.DoCommand(Container.RemovePriceSnapshot(_priceCardFriendlyId, _priceSnapshotId));
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
        }
        ...
        private static void SetSnapshotApprovalStatus()
        {
            ...
            result = Proxy.DoCommand(Container.AddPriceTier(_priceCardFriendlyId, snapshotId, "USD", 3, 13));
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
        ...
        private static void AddPriceTier()
        {
            ...
            result = Proxy.DoCommand(Container.AddPriceTier(_priceCardFriendlyId, "InvalidSnapshot", "USD", 3, 13));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");

            result = Proxy.DoCommand(Container.AddPriceTier(_priceCardFriendlyId, _priceSnapshotId, "USD", 3, 13));
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
            result.Models.OfType<PriceTierAdded>().FirstOrDefault().Should().NotBeNull();
        ...
        private static void EditPriceTier()
        {
            ...
            var result = Proxy.DoCommand(Container.EditPriceTier("InvalidCard", _priceSnapshotId, _priceTierId, 13));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");

            result = Proxy.DoCommand(Container.EditPriceTier(_priceCardFriendlyId, "InvalidSnapshot", _priceTierId, 13));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");

            result = Proxy.DoCommand(Container.EditPriceTier(_priceCardFriendlyId, _priceSnapshotId, "InvalidTiers", 13));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");

            result = Proxy.DoCommand(Container.EditPriceTier(_priceCardFriendlyId, _priceSnapshotId, _priceTierId, 13));
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
        }
        ...
        private static void RemovePriceTier()
        {
            ...
            var result = Proxy.DoCommand(Container.RemovePriceTier(_priceCardFriendlyId, _priceSnapshotId, "InvalidTier"));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");

            result = Proxy.DoCommand(Container.RemovePriceTier(_priceCardFriendlyId, "InvalidSnapshot", _priceTierId));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");

            result = Proxy.DoCommand(Container.RemovePriceTier(_priceCardFriendlyId, _priceSnapshotId, _priceTierId));
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
        }
        ...
        private static void AddPriceSnapshotTag()
        {
            ...
            var result = Proxy.DoCommand(Container.AddPriceSnapshotTag(_priceCardFriendlyId, _priceSnapshotId, "ThisIsATag"));
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();

            result = Proxy.DoCommand(Container.AddPriceSnapshotTag(_priceCardFriendlyId, _priceSnapshotId, "ThisIsATag"));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");
            ...
            result = Proxy.DoCommand(Container.AddPriceSnapshotTag(_priceCardFriendlyId, "InvalidSnapshot", "AnotherTag"));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");
        }
        ...
        private static void RemovePriceSnapshotTag()
        {
            ...
            var result = Proxy.DoCommand(Container.RemovePriceSnapshotTag("InvalidCard", _priceSnapshotId, "ThisIsATag"));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");

            result = Proxy.DoCommand(Container.RemovePriceSnapshotTag(_priceCardFriendlyId, "InvalidSnapshot", "ThisIsATag"));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");

            result = Proxy.DoCommand(Container.RemovePriceSnapshotTag(_priceCardFriendlyId, _priceSnapshotId, "InvalidTag"));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");

            result = Proxy.DoCommand(Container.RemovePriceSnapshotTag(_priceCardFriendlyId, _priceSnapshotId, "ThisIsATag"));
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
        }
