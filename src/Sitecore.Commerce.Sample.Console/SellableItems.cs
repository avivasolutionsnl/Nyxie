namespace Sitecore.Commerce.Sample.Console
{
    ...
    public static class SellableItems
    {
        ...
        private static void GetSellableItem_NoVariants()
        {
            ...
            var result = Proxy.GetValue(Container.SellableItems.ByKey("Adventure Works Catalog,AW014 08,").Expand("Components($expand=ChildComponents($expand=ChildComponents($expand=ChildComponents)))"));
        ...
        private static void GetSellableItem_WithVariants()
        {
            ...
            var result = Proxy.GetValue(Container.SellableItems.ByKey("Adventure Works Catalog,AW055 01,").Expand("Components($expand=ChildComponents($expand=ChildComponents($expand=ChildComponents)))"));
            result.Should().NotBeNull();
        ...
        private static void GetSellableItem_WithVariant()
        {
            ...
            var result = Proxy.GetValue(Container.SellableItems.ByKey("Adventure Works Catalog,AW055 01,33").Expand("Components($expand=ChildComponents($expand=ChildComponents($expand=ChildComponents)))"));
            result.Should().NotBeNull();
        ...
        private static void UpdateListPrices_SellableItem()
        {
            ...
            var sellableItemBefore = Proxy.GetValue(Container.SellableItems.ByKey("Adventure Works Catalog,AW140 13,").Expand("Components($expand=ChildComponents($expand=ChildComponents($expand=ChildComponents)))"));
            ...
            var result = Proxy.DoCommand(Container.UpdateListPrices("Adventure Works Catalog|AW140 13|", new List<Money> { price1, price2 }));
            result.Should().NotBeNull();
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();

            var sellableItem = Proxy.GetValue(Container.SellableItems.ByKey("Adventure Works Catalog,AW140 13,").Expand("Components($expand=ChildComponents($expand=ChildComponents($expand=ChildComponents)))"));
            ...
            result = Proxy.DoCommand(Container.UpdateListPrices("Adventure Works Catalog|AW140 13|", new List<Money> { Money.CreateMoney(10) }));
        ...
        private static void UpdateListPrices_Variation()
        {
            ...
            var result = Proxy.DoCommand(Container.UpdateListPrices("Adventure Works Catalog|AW140 13|41", new List<Money> { price1, price2 }));
            result.Should().NotBeNull();
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();

            var sellableItem = Proxy.GetValue(Container.SellableItems.ByKey("Adventure Works Catalog,AW140 13,41").Expand("Components($expand=ChildComponents($expand=ChildComponents($expand=ChildComponents)))"));
            sellableItem.Should().NotBeNull();
            ...
            result = Proxy.DoCommand(Container.UpdateListPrices("Adventure Works Catalog|AW140 13|41", new List<Money> { Money.CreateMoney(10) }));
            result.Messages.Any(m => m.Code.Equals("validationerror", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");
        }
        ...
        private static void RemoveListPrices_SellableItem()
        {
            ...
            result = Proxy.DoCommand(Container.RemoveListPrices("Adventure Works Catalog|AW140 13|", new List<Money> { price1 }));
            result.Should().NotBeNull();
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
            ...
            result = Proxy.DoCommand(Container.RemoveListPrices("Adventure Works Catalog|AW140 13|", new List<Money> { Money.CreateMoney(10) }));
        ...
        private static void RemoveListPrices_Variation()
        {
            ...
            result = Proxy.DoCommand(Container.RemoveListPrices("Adventure Works Catalog|AW140 13|41", new List<Money> { price1 }));
            result.Should().NotBeNull();
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeFalse();
            ...
            result = Proxy.DoCommand(Container.RemoveListPrices("Adventure Works Catalog|AW140 13|41", new List<Money> { Money.CreateMoney(10) }));
            result.Messages.Any(m => m.Code.Equals("error", StringComparison.OrdinalIgnoreCase)).Should().BeTrue();
            ConsoleExtensions.WriteColoredLine(ConsoleColor.Yellow, "Expected error");
        }
    }
