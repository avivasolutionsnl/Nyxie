...
namespace Plugin.Sample.Customers.CsMigration
{
    ...
    public class ProfilesSqlPolicy : Policy
    {
        ...
        public string ConnectionString()
        {
            ...
            _connectionString = TrustedConnection ? $"Server={Server};Database={Database};Trusted_Connection=True;Connect Timeout={ConnectTimeout}{additionalParameters}" : $"Server={Server};Database={Database};Connect Timeout={ConnectTimeout};User={UserName};Password={Password}{additionalParameters}";
