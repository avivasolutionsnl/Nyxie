...
namespace Plugin.Sample.Customers.CsMigration
{
    ...
    public class ProfilePropertiesMappingPolicy : Policy
    {
        ...
        /// The user properties.
        /// </value>
        public Dictionary<string, string> UserProperties { get; private set; } = new Dictionary<string, string>();
        ...
        /// </value>
        public Dictionary<string, string> AddressProperties { get; private set; } = new Dictionary<string, string>();
    }       
}
