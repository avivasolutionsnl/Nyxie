...
using Nyxie.Plugin.Promotions.Tests.Persistence;
...
using FindEntitiesInListBlock = Nyxie.Plugin.Promotions.Tests.Persistence.Pipelines.Blocks.FindEntitiesInListBlock;
using FindEntityBlock = Nyxie.Plugin.Promotions.Tests.Persistence.Pipelines.Blocks.FindEntityBlock;

namespace Nyxie.Plugin.Promotions.Tests
{
