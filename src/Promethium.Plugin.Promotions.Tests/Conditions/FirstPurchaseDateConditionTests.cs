...
namespace Promethium.Plugin.Promotions.Tests.Conditions
{
    ...
    { 
        ...
        public FirstPurchaseDateConditionTests(EngineFixture engineFixture, ITestOutputHelper testOutputHelper)
        {
        ...
        public async void Should_match_operator(Operator @operator, DateTimeOffset promotionDate, DateTimeOffset firstOrderDate, bool shouldQualify)
        {
            ...
            var laterOrder = new OrderBuilder().PlacedOn(firstOrderDate.AddDays(100)).Build();
