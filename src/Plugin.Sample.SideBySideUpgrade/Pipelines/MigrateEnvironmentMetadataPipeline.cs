...
namespace Plugin.Sample.SideBySideUpgrade
{
    ...
    /// <seealso>
    ///   <cref>
    /// Sitecore.Commerce.Core.CommercePipeline{Plugin.Sample.SideBySideUpgrade.MigrateEnvironmentArgument,
    /// Sitecore.Commerce.Core.CommerceEnvironment}
    /// </cref>
    /// </seealso>
    /// <seealso cref="Plugin.Sample.SideBySideUpgrade.IMigrateEnvironmentMetadataPipeline" />
