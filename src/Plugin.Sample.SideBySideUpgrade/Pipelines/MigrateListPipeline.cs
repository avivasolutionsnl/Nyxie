...
namespace Plugin.Sample.SideBySideUpgrade
{
    ...
    /// <seealso>
    ///   <cref>
    /// Sitecore.Commerce.Core.CommercePipeline{Plugin.Sample.SideBySideUpgrade.MigrateListArgument,
    /// System.Boolean}
    /// </cref>
    /// </seealso>
    /// <seealso cref="Plugin.Sample.SideBySideUpgrade.IMigrateListPipeline" />
