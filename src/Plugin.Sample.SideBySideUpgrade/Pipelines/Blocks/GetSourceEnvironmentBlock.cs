...
namespace Plugin.Sample.SideBySideUpgrade
{
    ...
    /// <seealso>
    ///     <cref>
    ///         Sitecore.Commerce.Core.PipelineBlock{Plugin.Sample.SideBySideUpgrade.MigrateEnvironmentArgument,
    ///         Sitecore.Commerce.Core.CommerceEnvironment, Sitecore.Commerce.Core.CommercePipelineExecutionContext}
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(SideBySideUpgradeConstants.GetSourceEnvironmentBlock)]
