...
namespace Plugin.Sample.SideBySideUpgrade
{
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(SideBySideUpgradeConstants.GetTargetEntityBlock)]
    public class GetTargetEntityBlock : PipelineBlock<FindEntityArgument, FindEntityArgument, CommercePipelineExecutionContext>
    {
        ...
        public override async Task<FindEntityArgument> Run(FindEntityArgument arg, CommercePipelineExecutionContext context)
        {
            ...
            var targetEntity = await _findEntityCommand.Process(context.CommerceContext, typeof(CommerceEntity), arg.EntityId).ConfigureAwait(false);
