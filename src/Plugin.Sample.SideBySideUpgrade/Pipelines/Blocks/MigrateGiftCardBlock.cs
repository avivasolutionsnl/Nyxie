...
namespace Plugin.Sample.SideBySideUpgrade
{
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(SideBySideUpgradeConstants.MigrateGiftCardBlock)]
    public class MigrateGiftCardBlock : PipelineBlock<CommerceEntity, CommerceEntity, CommercePipelineExecutionContext>
    {
        ...
        public override async Task<CommerceEntity> Run(CommerceEntity arg, CommercePipelineExecutionContext context)
        {
            ...
            {
                await this._persistEntityPipeline.Run(new PersistEntityArgument(indexByGiftCardCode), context).ConfigureAwait(false);
            }
