...
namespace Plugin.Sample.SideBySideUpgrade
{
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(SideBySideUpgradeConstants.PersistMigratedEntityBlock)]
    public class PersistMigratedEntityBlock : PipelineBlock<CommerceEntity, CommerceEntity, CommercePipelineExecutionContext>
    {
        ...
        public override async Task<CommerceEntity> Run(CommerceEntity arg, CommercePipelineExecutionContext context)
        {
            ...
            await this._persistEntityPipeline.Run(new PersistEntityArgument(arg), context).ConfigureAwait(false);
            return arg;
        }        
    }
}
