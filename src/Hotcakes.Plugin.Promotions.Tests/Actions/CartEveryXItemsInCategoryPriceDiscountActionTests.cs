    ...
    public class CartEveryXItemsInCategoryPriceDiscountActionTests
    {
        ...
        public async void Should_benefit_when_category_matches()
        {
            ...
            AwardedAdjustment adjustment =
                line.Adjustments.Single(x => x.AwardingBlock == nameof(CartEveryXItemsInCategoryPriceDiscountAction));
        ...
        public async void Should_not_benefit_multiple_times_when_exceeds_action_limit()
        {
            ...
            Assert.DoesNotContain(secondLine.Adjustments,
                x => x.AwardingBlock == nameof(CartEveryXItemsInCategoryPriceDiscountAction));
