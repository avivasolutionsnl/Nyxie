...
namespace Hotcakes.Plugin.Promotions.Tests.Actions
{
    ...
    public class CartItemsMatchingInCategoryPercentageDiscountActionTests
    {
        ...
        public CartItemsMatchingInCategoryPercentageDiscountActionTests(EngineFixture engineFixture,
        ...
        public async void Should_benefit_multiple_times_when_within_action_limit()
        {
            ...
            AwardedAdjustment adjustment = firstLine.Adjustments.Single(x =>
                x.AwardingBlock ==
                nameof(CartItemsMatchingInCategoryPercentageDiscountAction));
            Assert.Equal(-20, adjustment.Adjustment.Amount);
            ...
            AwardedAdjustment secondAdjustment =
                secondLine.Adjustments.Single(x => x.AwardingBlock == nameof(CartItemsMatchingInCategoryPercentageDiscountAction));
