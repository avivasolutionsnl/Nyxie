...
namespace Promethium.Plugin.Promotions.Actions
{
    ...
    public class CartItemsMatchingInCategoryPriceDiscountAction : ICartLineAction
    {
        ...
        public void Execute(IRuleExecutionContext context)
        {
            ...
            {
                categoryLines.ApplyAction(commerceContext, amountOff, applyActionTo, awardLimit, nameof(CartItemsMatchingInCategoryPriceDiscountAction), ActionExtensions.CalculateAmountDiscount);
            }
        }
    }
}
